...
public class Dosjugadores extends BaseGameActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.tablero);
		 ...
		 // La publicidad va aquí:
		    ...
		    LinearLayout layout = (LinearLayout)findViewById(R.id.tablero_uno);
        ...
        TimerTask task = new TimerTask() { //definimos a Task
            ...
            public void run() {
        		if (getGamesClient().isConnected()) {
        	        final String logro_multijugador = getString(R.string.logro_multijugador_5);
        	        getGamesClient().incrementAchievement(logro_multijugador, 1);
        		}
            }
          };
